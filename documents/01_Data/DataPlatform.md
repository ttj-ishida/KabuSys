...
低コスト最小構成（J-Quants + kabuステーション API + Yahoo News）における各情報源の役割を以下のように定義する。

| 情報源 | 役割 | 唯一の正 |
| --- | --- | --- |
| **J-Quants** | 市場・財務・銘柄マスタの基盤データ源。日足株価・財務・銘柄一覧・カレンダー・配当・TOPIX はすべて J-Quants から取得する | ✅ バックテスト・特徴量生成・戦略シグナルの入力データはすべて J-Quants 由来 |
