...
| Item | Value |
|------|-------|
| Run ID | `66eb57ec-cffe-4234-978b-b8108e3e5219` |
| Generated | 2026-05-23T16:31:42+00:00 |
| Period | 2017-01-01 → 2025-12-31 |
| Report Type | portfolio_backtest |
...
| Commission Rate | 0.00055 |
| Risk % (risk_based) | 0.005 |
| Stop Loss % | 9% |
| Lot Size | 100 |
...
|--------|-------|
| Initial Cash | 1,000,000 JPY |
| Final Value | 1,000,000 JPY |
| Total Return | +0.00% |
| CAGR | +0.00% |
| Realized P&L | +0 JPY |
| Total Commission | 0 JPY |
...
- ⚠️ 総トレード数が少ないです（0件）。統計的信頼性が低い可能性があります。
